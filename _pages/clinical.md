...
-  ![chromoseq](/images/respic/chromoseq.png){:height="200px" class="img-responsive" style="float: left"} **ChromoSeq:** Streamlined
...
- ![amlclearance](/images/respic/amlclearance.png){:height="200px"} **AML Clearance Exome Sequencing:** This assay uses deep exome
